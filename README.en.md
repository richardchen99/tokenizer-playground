...
**From corpus to vocabulary: understand BPE one merge at a time.**
...
[**Open the playground ↗**](https://richardchen99.github.io/tokenizer-playground/) · [Research note · 中文](https://richardchen99.github.io/blog/tokenizer-playground-note/) · [简体中文](README.md) · [Quick start](#quick-start)
...
![BPE framework showing weighted pair counting and merge training, followed by ordered-rule encoding and reconstruction](docs/assets/architecture.en.png)

*Original schematic: training learns an ordered rule list; encoding reuses it without relearning frequencies. [Editable SVG](docs/assets/architecture.en.svg) · [Figure provenance · 中文](docs/assets/README.md).*
